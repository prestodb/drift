        ...
        switch (type) {
            case THRIFT_FIELD:
                if (annotation != null) {
                    ...
                    else if (idlAnnotations.containsKey(ThriftIdlAnnotation.RECURSIVE_REFERENCE_ANNOTATION_KEY)) {
                        isRecursiveReference = "true".equalsIgnoreCase(idlAnnotations.getOrDefault(ThriftIdlAnnotation.RECURSIVE_REFERENCE_ANNOTATION_KEY, "false"));
                    }
                }
                break;
