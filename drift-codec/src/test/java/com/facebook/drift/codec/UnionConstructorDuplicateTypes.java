...
public class UnionConstructorDuplicateTypes
{
    ...
    @ThriftField(value = 1, name = "firstIntValue", requiredness = ThriftField.Requiredness.NONE)
    ...
    @ThriftField(value = 2, name = "secondIntValue", requiredness = ThriftField.Requiredness.NONE)
