...
public class ThriftIdlGenerator
{
    ...
    public ThriftIdlGenerator(ThriftIdlGeneratorConfig config, ClassLoader classLoader)
    {
        ...
        MetadataErrors.Monitor monitor = createMonitor(config.getErrorLogger(), config.getWarningLogger());
    ...
    private String generate()
    {
        ...
        return ThriftIdlRenderer.renderThriftIdl(namespaces, includesBuilder.build(), thriftTypes, thriftServices, typeRenderer);
    }
    ...
    private static MetadataErrors.Monitor createMonitor(Consumer<String> errorLogger, Consumer<String> warningLogger)
    {
