...
final class DriftNettyTesterUtil
{
            ...
            boolean secure)
    {
        ...
        try (TestingPooledByteBufAllocator testingAllocator = new TestingPooledByteBufAllocator();
            ...
            DriftClientFactory proxyFactory = clientFactoryManager.createDriftClientFactory("clientIdentity", addressSelector, ExceptionClassifier.NORMAL_RESULT);
            ...
            boolean secure)
    {
        ...
        try (TestingPooledByteBufAllocator testingAllocator = new TestingPooledByteBufAllocator();
                DriftNettyMethodInvokerFactory<?> methodInvokerFactory = DriftNettyMethodInvokerFactory.createStaticDriftNettyMethodInvokerFactory(config, testingAllocator)) {
            ...
            boolean secure)
    {
        ...
        try (TestingPooledByteBufAllocator testingAllocator = new TestingPooledByteBufAllocator();
            ...
            DriftClientFactory proxyFactory = proxyFactoryManager.createDriftClientFactory("myFactory", addressSelector, ExceptionClassifier.NORMAL_RESULT);
    ...
    private static boolean isValidConfiguration(Transport transport, Protocol protocol)
    {
        ...
        return transport != Transport.HEADER || protocol != Protocol.COMPACT;
    }
}
