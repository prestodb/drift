            ...
            throws Exception
    {
        ...
        Bootstrap bootstrap = new Bootstrap(
                ...
                binder -> {
                    ...
                    DriftClientBinder.driftClientBinder(binder).bindDriftClient(ThrowingService.class).withAddressSelector(SimpleAddressSelectorBinder.simpleAddressSelector())
