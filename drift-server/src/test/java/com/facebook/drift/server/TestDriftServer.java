...
public class TestDriftServer
{
    ...
    public void testGuiceServer()
    {
        ...
        Bootstrap app = new Bootstrap(
                ...
                binder -> DriftServerBinder.driftServerBinder(binder).bindService(TestService.class),
                binder -> binder.bind(ServerTransportFactory.class).toInstance(serverTransportFactory),
                binder -> OptionalBinder.newOptionalBinder(binder, MethodInvocationStatsFactory.class)
                        .setBinding()
    ...
    public void testGuiceServerFilter()
    {
        ...
        Bootstrap app = new Bootstrap(
                binder -> binder.bind(TestService.class).toInstance(testService),
                binder -> DriftServerBinder.driftServerBinder(binder).bindService(TestService.class),
                binder -> DriftServerBinder.driftServerBinder(binder).bindFilter(passThroughFilter),
                binder -> DriftServerBinder.driftServerBinder(binder).bindFilter(shortCircuitFilter),
                binder -> binder.bind(ServerTransportFactory.class).toInstance(serverTransportFactory),
