        ...
        extends ChannelDuplexHandler
{
            ...
            if (e.getFrameInfo().isPresent()) {
                ...
                try {
                    context.writeAndFlush(writeApplicationException(
                            ...
                            TApplicationException.Type.PROTOCOL_ERROR,
                            e.getMessage(),
                            e));
                }
                catch (Throwable t) {
            ...
            throws Exception
    {
        ...
        if (!methodMetadata.isPresent()) {
            return immediateFuture(writeApplicationException(
                    ...
                    TApplicationException.Type.UNKNOWN_METHOD,
            ...
            throws Exception
    {
        ...
        TApplicationException.Type type = TApplicationException.Type.INTERNAL_ERROR;
        if (exception instanceof TApplicationException) {
            type = ((TApplicationException) exception).getType().orElse(TApplicationException.Type.INTERNAL_ERROR);
        }
